...
(function() {
	...
	mywebsite = (function() {
		...
		mywebsite.prototype.animateHomeimg = function() {
			return jQuery("#home .welcome_block").waypoint(function() {
				return new Animo({
					...
					el: jQuery("#home .welcome_block a"),
					duration: 1500,
					delay: 800,
					template: {
						opacity: [0, 1],
		...
		mywebsite.prototype.animateTestimonials = function() {
			return jQuery("#testimonials").waypoint(function() {
				return new Animo({
					el: jQuery("#testimonials .left_effect"),
					delay: 500,
					duration: 900,
						template: {
						translateY: [-100, 0, "%"],
		...
		mywebsite.prototype.animateContact = function() {
			return jQuery("#contact").waypoint(function() {
				return new Animo({
					el: jQuery("#contact input, #contact textarea"),
					duration: 800,
					delay: 1000,
					template: {
						opacity: [0, 1],
	...
	mywebsite.prototype.animateContactInfo = function() {
			return jQuery("#contact_info").waypoint(function() {
				return new Animo({
					el: jQuery("#contact_info .contact_info, #contact_info h3.opacity"),
					duration: 800,
					delay: 1000,
					template: {
						opacity: [0, 1],
